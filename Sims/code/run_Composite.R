...
for (idx in 1:n.simulations)
{
  ...
  write(PredictedValuesCurrent,paste(CompositeDC,"CompositeDC_PredictedValuesCurrent_",idx,".txt",sep=""),ncol=1)
  write(ErrorToTruthCurrent,paste(CompositeDC,"CompositeDC_ErrorToTruthCurrent_",idx,".txt",sep=""),ncol=1)        
}
